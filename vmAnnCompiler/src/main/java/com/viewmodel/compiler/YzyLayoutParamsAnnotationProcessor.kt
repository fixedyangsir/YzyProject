...
annotation class InjectLayoutParams(
    val value: KClass<*>,
...
class YzyLayoutParamsAnnotationProcessor : AbstractProcessor() {
    ...
    override fun getSupportedAnnotationTypes(): Set<String>? {
        val types: MutableSet<String> =
            LinkedHashSet()
        types.add(InjectLayoutParams::class.java.canonicalName)
        return types
    }
    ...
    override fun process(
        ...
        val elements = roundEnv.getElementsAnnotatedWith(InjectLayoutParams::class.java)
        ...
        for (element in elements) {
            ...
            val moudleName: String =
                getMyValue(variableElement, InjectLayoutParams::class.java, "value").toString()
                    .split(".").last()
        ...
        if (map.isNotEmpty()) {
            ...
            while (iterator.hasNext()) {
                ...
                try {
                    ...
                    writer.write("import com.yzy.lib_protocal.base.IYzyLayoutParamsSupport\n")


                    writer.write("open public class $moudleName: IYzyLayoutParamsSupport{\n")

                    writer.write(" override fun loadInto(support: MutableMap<String, String>) {\n")


                    writer.write("support.put(")
                    writer.write("""
                    "${key.replace("Params","")}","$packageName.$key")
                    """)
